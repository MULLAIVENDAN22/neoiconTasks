...
// You are creating a simple game where players gain or lose points. You want to:

// Increase the player's score before showing it when they collect a bonus (pre-increment).

// Show the current score when a player loses a point but decrement after showing it (post-decrement).

// Keep track of total bonuses collected and penalties applied using increments.
